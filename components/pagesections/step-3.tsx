...
export function Step3({setSelectedImage}: Step3Props){
    return(
        <ProjectSection id="step-3" title="Step 3: VPC Peering" onImageClick={setSelectedImage}>
            ...
            <ImageContainer className="mb-1"src="./vpc-peer-requester.jpeg" alt="vpc peering requester" selectedImage={setSelectedImage} />
            <ImageContainer className="mb-1"src="./vpc-peer-accepter.jpeg" alt="vpc peering accepter" selectedImage={setSelectedImage} />
